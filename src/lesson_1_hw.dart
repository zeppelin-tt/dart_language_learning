...
void main(){
print ('Результат задачи 1:${first(21,8)}');
print ('Результат задачи 2:${second(73)}');
print ('Результат задачи 3:${third(17.325)}');
print ('Результат задачи 4:${fourth(275)}');
} 
